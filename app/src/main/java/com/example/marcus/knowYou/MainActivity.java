...
public class MainActivity extends FragmentActivity {
    //Fragments
    private Class[] fragments = new Class[]{Travel.class, null, null, Community.class, Me.class};
    //labels
    ...
    private void initView() {
        ...
        //对第二个标签"发现"进行单独设置,点击加载新的activity.
        ...
        tabHost.getTabWidget().getChildAt(2).setOnClickListener(new View.OnClickListener() {
            ...
            private void showPopWindow(View v) {
                ...
                View view = LayoutInflater.from(MainActivity.this).inflate(R.layout.bottom_fragmenttabhost_showpopupwindow, null);
