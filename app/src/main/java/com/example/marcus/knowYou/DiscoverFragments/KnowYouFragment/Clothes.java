...
public class Clothes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.discover_knowyou_clothes,null);
    ...
    private void setStaggeredGridView() {
        ...
        ListAdapter adapter = new SimpleAdapter(getActivity(),datas,R.layout.discover_knowyou_clothes_gridview,
